...
<div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="card card-info">
                ...
                <form class="form-horizontal" method="post" action="{{ route('backend.laporan.tahunan')}}">
                    {{csrf_field()}}
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control numberonly" name="tahun" id="tahun" maxlength="4">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="kecamatan" class="col-sm-2 control-label">Jenis</label>
                            <div class="col-sm-10">
    ...
    <div class="col-md-12">
        <div class="box">
                ...
                <div class="box-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($data as $k => $v)
                            <tr>
                                ...
                                <td>{{$v->panjang}}</td>
                                <td>{{$v->lebar}}</td>
                                <td>{{$v->kecamatan_dilalui}}</td>
                                <td>{{$v->tahun}}</td>
                                <td>{{$v->pembiayaan}}</td>
                                <td>{{$v->biaya}}</td>
                                <td>{{$v->jenis}}</td>
                                <td>{{substr(strip_tags($v->ket),0,150)}}</td>
                            </tr>
                        @endforeach
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a href="{{ route('backend.laporan.exportexcel',['tipe'=>'tahunan'])}}">
